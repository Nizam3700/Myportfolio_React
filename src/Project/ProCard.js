            ...
            <div class="max-w-sm border items-center content-center m-auto border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                ...
                <p className=" justify-center text-cyan-200">
                  QEats is a popular food ordering app that allows users to
                  browse and order their favorite dishes from nearby
                  restaurants.
                </p>
                <div className="m-1">
              ...
              <a href="https://www.crio.do/learn/portfolio/nizamuddin8637/ME_QEATS_V2/?edit=true" target="_blank"><button type="button" class="text-black bg-gradient-to-br from-green-600 to-yellow-300 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-500 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">View Project Details</button></a>
            </div>
          </section>
    </>
  )
