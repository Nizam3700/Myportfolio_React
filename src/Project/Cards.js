...
export function Component() {
  return (
    <Card className="max-w-max mx-auto inline-flex horizontal" 
    
    imgSrc="" >
        <img className="max-h-96 max-w-96" src="https://crio-directus-assets.s3.ap-south-1.amazonaws.com/bcf8d7c1-09ec-40d6-9e8a-1047648e7e9f.png" alt="QEats_pic" />
