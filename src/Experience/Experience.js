          ...
          <ol class="relative border-s border-gray-200 dark:border-gray-700">
            <li class="mb-10 ms-6">
              ...
              <time class="block text-left mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
                I Recently Graducated from Bachelor of Science in PVKN Govt College(Autonomous), Chittoor 
              </time>
            ...
            <li class="ms-6">
              ...
              I Completed my Secondary School With Good CGPA 9.0, 2018-2019
              </time>
              <p class="text-base font-normal text-gray-500 dark:text-gray-400">
