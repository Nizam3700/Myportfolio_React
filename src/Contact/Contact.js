    ...
    <>
      <section className="mt-12">
        ...
        <main className="text-center font-sans align-middle md:flex flex-wrap justify-center items-center">
          ...
          <div className="h-48 w-80 m-4 border rounded-2xl bg-slate-400 text-left">
          ...
          <div className="h-48 w-80 m-4 border rounded-2xl bg-slate-400 text-left">
            ...
            <a href="https://wa.me/7396183700" target="_blank" className="inline-flex font-medium items-center ml-8 text-blue-600 hover:underline">
              Message me
            </a>
          </div>
          ...
          <div className="h-48 w-80 m-4 border rounded-2xl bg-slate-400 text-left">
            ...
            <a href="https://www.linkedin.com/in/nizam3700" target="_blank" className="inline-flex font-medium items-center ml-8 text-blue-600 hover:underline">
              Profile
            </a>
          </div>
          ...
          <div className="h-48 w-80 m-4 border rounded-2xl bg-slate-400 text-left">
            ...
            <a href="mailto:nizamuddin8637@gmail.com" target="_blank" className="inline-flex font-medium items-center ml-8 text-blue-600 hover:underline">
              mail me
            </a>
          </div>
