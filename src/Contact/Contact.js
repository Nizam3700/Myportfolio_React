...
import { faSquareWhatsapp, faLinkedin,faGithub } from "@fortawesome/free-brands-svg-icons";
      ...
      <section className="mt-12">
        ...
        <main className="text-center font-sans align-middle md:flex md:flex-wrap flex flex-col lg:flex-row justify-center items-center mx-auto gap-4 ">
          ...
          <div className="h-40 w-60 m-4 border rounded-2xl bg-slate-400 text-left">
            ...
            <h1 className="text-xl font-bold ml-8 text-gray-600">Chittoor, A.P, India</h1>
          </div>
          ...
          <div className="h-40 w-60 m-4 border rounded-2xl bg-slate-400 text-left">
            <div className="flex ml-6 mt-4">
              <FontAwesomeIcon icon={faGithub} size="2xl" className="h-10" style={{ color: "#121212" }} />
            </div>
